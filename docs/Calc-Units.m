...
- (CGFloat) getTemperature: (CGFloat) temperatureCalibrated {
    return [RHTPoint adjustCelsiusTemperature:(_temperatureInCelsius + temperatureCalibrated)
                                      forUnit:[[Settings userDefaults] tempUnitType]];
}

- (CGFloat) getHumidity: (CGFloat) humidityCalibrated {
    return _relativeHumidity + humidityCalibrated;
}

- (CGFloat) getDewPoint: (CGFloat) humidityCalibrated {
    return [RHTPoint getDewPointForHumidity:(_relativeHumidity + humidityCalibrated)
                              atTemperature:_temperatureInCelsius];
}

- (CGFloat) getHeatIndex: (CGFloat) temperatureCalibrated humidityCalibrated: (CGFloat) humidityCalibrated {
    CGFloat heatIndexInCelsius = [RHTPoint getHeatIndexInCelsiusForHumidity:(_relativeHumidity + humidityCalibrated)
                                                              atTemperature:(_temperatureInCelsius + temperatureCalibrated)];
